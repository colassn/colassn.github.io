...
const CURRENT_RELEASE_NOTICE = {
  version: window.__EHANDBOOK_VERSION__ || 'v3.2.0-studyos-collaboration',
  title: 'StudyOS 3.2.0 Spark 群組協作',
...
function LegacyUserSettingsPage(_ref27) {
  ...
  return React.createElement("div", {
    ...
    name: "badge-check",
    className: "w-3.5 h-3.5"
  }), " v3.2.0 \u5168\u9801\u5DE5\u4F5C\u5340"), React.createElement("h2", {
...
function UserSettingsPage(_ref34) {
  ...
  }, "v3.2.0")))), React.createElement("div", {
  ...
  }, "StudyOS 3.2.0 Spark")), React.createElement("div", {
...
function App() {
  ...
  }, "StudyOS v3.2.0 Spark")), viewMode === 'current' && appMode === 'personal' && React.createElement("button", {
    type: "button",
